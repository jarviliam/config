  ...
  config = function()
    require("gitsigns").setup({
      ...
      on_attach = function(bufnr)
        ...
        vim.keymap.set({ "n", "x", "o" }, "]g", function() utils.call_and_center(next_hunk) end, { desc = "go to next change" })
        vim.keymap.set({ "n", "x", "o" }, "[g", function() utils.call_and_centre(prev_hunk) end, { desc = "go to previous change" })
        -- stylua: ignore end
      end,
    })
  end,
